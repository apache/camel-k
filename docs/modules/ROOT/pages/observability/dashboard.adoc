...
NOTE: From version 2.11.0 onward the `camel-observability-services` component, required to get the full power of this monitoring tool, is included by default.
