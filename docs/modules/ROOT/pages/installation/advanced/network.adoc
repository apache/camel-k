...
We suggest you to check the xref:installation/builds.adoc[Builds configuration] page which contains all the details required to fine tune the build phase.
