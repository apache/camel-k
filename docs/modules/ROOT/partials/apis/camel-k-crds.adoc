...
|`buildStrategy` +
*xref:#_camel_apache_org_v1_IntegrationPlatformBuildStrategy[IntegrationPlatformBuildStrategy]*
|
...
|`registry` +
*xref:#_camel_apache_org_v1_IntegrationPlatformRegistrySpec[IntegrationPlatformRegistrySpec]*
|
...
[#_camel_apache_org_v1_IntegrationPlatformBuildStrategy]
...
[#_camel_apache_org_v1_IntegrationPlatformRegistrySpec]
...
[#_camel_apache_org_v1_PlatformInjectable]
=== PlatformInjectable
