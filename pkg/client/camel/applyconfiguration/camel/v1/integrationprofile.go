...
// IntegrationProfileApplyConfiguration represents an declarative configuration of the IntegrationProfile type for use
// with apply.
...
// IntegrationProfile constructs an declarative configuration of the IntegrationProfile type for use with
// apply.
