...
// BrokerV1beta1Client is used to interact with features provided by the broker.amq.io group.
...
func (c *BrokerV1beta1Client) ActiveMQArtemisAddresses(namespace string) ActiveMQArtemisAddressInterface {
...
// NewForConfigAndClient creates a new BrokerV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*BrokerV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := arkmqv1beta1.SchemeGroupVersion
