...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QuarkusRuntimeProvider) DeepCopyInto(out *QuarkusRuntimeProvider) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QuarkusRuntimeProvider.
func (in *QuarkusRuntimeProvider) DeepCopy() *QuarkusRuntimeProvider {
	if in == nil {
		return nil
	}
	out := new(QuarkusRuntimeProvider)
	in.DeepCopyInto(out)
	return out
}
