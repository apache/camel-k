...
func (in *MountTrait) DeepCopyInto(out *MountTrait) {
	*out = *in
	...
	if in.ConfigsAsPropertyFiles != nil {
		in, out := &in.ConfigsAsPropertyFiles, &out.ConfigsAsPropertyFiles
		*out = new(bool)
		**out = **in
	}
	if in.ScanConfigsForProperties != nil {
		in, out := &in.ScanConfigsForProperties, &out.ScanConfigsForProperties
		*out = new(bool)
		**out = **in
	}
