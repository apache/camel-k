...
func (o *runCmdOptions) uploadFileOrDirectory(platform *v1.IntegrationPlatform, file string, integrationName string, cmd *cobra.Command, integration *v1.Integration) error {
	uri := parseFileURI(file)
