...
func (t *openAPITrait) Configure(e *Environment) (bool, error) {
	...
	if _, ok := e.CamelCatalog.Runtime.Capabilities[v1.CapabilityRest]; !ok {
		return false, fmt.Errorf(
			"the runtime provider %s does not declare 'rest' capability",
...
func (t *openAPITrait) generateFromDataSpecs(e *Environment, tmpDir string, specs []v1.DataSpec) (
	[]v1.SourceSpec, error,
) {
...
func (t *openAPITrait) generateOpenAPIConfigMap(e *Environment, resource v1.DataSpec,
	tmpDir, generatedContentName string) error {
	cm := corev1.ConfigMap{}
	key := ctrl.ObjectKey{
...
func (t *openAPITrait) createNewOpenAPIConfigMap(e *Environment, resource v1.DataSpec,
	tmpDir, generatedContentName string) error {
