...
func (t *deployerTrait) Apply(e *Environment) error {
	...
	case v1alpha1.IntegrationPhaseNone, v1alpha1.IntegrationPhaseWaitingForPlatform, v1alpha1.IntegrationPhaseInitialization, v1alpha1.IntegrationPhaseDeploying:
