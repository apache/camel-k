...
require (
	...
	github.com/apache/camel-k/pkg/apis/camel v1.10.1
	github.com/apache/camel-k/pkg/client/camel v1.10.1
	github.com/apache/camel-k/pkg/kamelet/repository v1.10.1
