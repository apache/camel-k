...
func TestCustomComponent(t *testing.T) {
	...
	WithNewTestNamespace(t, func(ctx context.Context, g *WithT, ns string) {
		name := RandomizedSuffixName("customcomp")
		g.Expect(KamelRun(t, ctx, ns,
			"files/custom-echo-component.yaml",
		...
		g.Eventually(IntegrationLogs(t, ctx, ns, name)).Should(ContainSubstring("echo: Hello Camel"))
	})
}
