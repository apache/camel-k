...
func TestKameletImplicitConfigDefaultUserProperty(t *testing.T) {
	...
	WithNewTestNamespace(t, func(ctx context.Context, g *WithT, ns string) {
		...
		t.Run("run test default config using properties", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/TimerKameletIntegrationConfiguration01.java",
		...
		t.Run("run test default config using mounted secret", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/TimerKameletIntegrationConfiguration03.java",
		...
		t.Run("run test default config using mounted configmap", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/TimerKameletIntegrationConfiguration04.java",
		...
		t.Run("run test named config using properties", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/TimerKameletIntegrationNamedConfiguration05.java",
		...
		t.Run("run test named config using labeled secret", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/TimerKameletIntegrationNamedConfiguration06.java",
		...
		t.Run("run test named config using mounted secret", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/TimerKameletIntegrationNamedConfiguration07.java",
		...
		t.Run("run test named config using mounted configmap", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/TimerKameletIntegrationNamedConfiguration08.java",
		...
		t.Run("run test default config using labeled secret", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/TimerKameletIntegrationConfiguration09.java",
				"--name", name).Execute()).To(Succeed())
			g.Eventually(IntegrationPodPhase(t, ctx, ns, name), TestTimeoutLong).Should(Equal(corev1.PodRunning))
		...
		t.Run("run test default config inlined properties", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/timer-kamelet-integration-inlined-configuration-01.yaml",
				"--name", name).Execute()).To(Succeed())
			g.Eventually(IntegrationPodPhase(t, ctx, ns, name), TestTimeoutLong).Should(Equal(corev1.PodRunning))
		...
		t.Run("run test default config parameters properties", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/timer-kamelet-integration-parameters-configuration-02.yaml",
		...
		t.Run("run test default config secret properties", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/timer-kamelet-integration-parameters-configuration-03.yaml",
				"-t", "mount.configs=secret:"+secretName,
				"--name", name).Execute()).To(Succeed())
			g.Eventually(IntegrationPodPhase(t, ctx, ns, name), TestTimeoutLong).Should(Equal(corev1.PodRunning))
		...
		t.Run("run test default config configmap properties", func(t *testing.T) {
			...
			g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "files/timer-kamelet-integration-parameters-configuration-04.yaml",
				"-t", "mount.configs=configmap:"+cmName,
				"--name", name).Execute()).To(Succeed())
			g.Eventually(IntegrationPodPhase(t, ctx, ns, name), TestTimeoutLong).Should(Equal(corev1.PodRunning))
