...
func TestConfigmapHotReload(t *testing.T) {
	...
	WithNewTestNamespace(t, func(ctx context.Context, g *WithT, ns string) {
		...
		g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "./files/config-configmap-route.yaml",
...
func TestSecretHotReload(t *testing.T) {
	WithNewTestNamespace(t, func(ctx context.Context, g *WithT, ns string) {
		...
		g.Expect(CamelKRunWithID(t, ctx, operatorID, ns, "./files/config-secret-route.yaml",
