...
`
	Resources["camel-catalog-3.0.0-M1.yaml"] =
		`
apiVersion: camel.apache.org/v1alpha1
kind: CamelCatalog
metadata:
  name: camel-catalog-3.0.0-m1
  labels:
    app: camel-k
    camel.apache.org/catalog.version: 3.0.0-M1
    camel.apache.org/catalog.loader.version: 3.0.0-M1
spec:
  version: 3.0.0-M1
  artifacts:
    camel-activemq:
